...
$sql = "INSERT INTO pagos (datos_pago,pago_hoy,mes_actual_pago,year_actual_pago,name_user,id_user, deuda,variable_boleta,pago_mes, estado_pago,cantidad_mes) 

VALUES ('$beneficiario','$hoy','$mes_actual','$year_actual','$name_user','$id_user','$monto','EGR','$mayus_mes','1','1')";

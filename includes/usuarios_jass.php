                         ...
                         if ($estado==0) { ?>
                          ...
                          <!--   <td><?php if ($estado==0) {
                            ...
                            <td>
                                        ...
                                        <button type="button" id="btnmodall" class="btn btn-warning" data-toggle="modal" data-target="#ModalEditt" data-unno="<?php echo $id_jass; ?>" data-dos="<?php echo $nombre; ?>" data-tres="<?php echo $ap_paterno;?>" data-materno2="<?php echo $ap_materno;  ?>" data-dnijass3="<?php echo $dni_jass;  ?>" >
                                         <i class="fa fa-plus"></i>

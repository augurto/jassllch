                         ...
                         if ($estado==0) { ?>
                            ...
                            <td>
                                        ...
                                        <i class="fa fa-edit"></i>
                                         ...
                                         <button type="button" id="btnmodal" class="btn btn-dark" data-toggle="modal" data-target="#ModalEdit" data-nom="<?php echo $id_jass; ?>" data-nom2="<?php echo $nombre_proyecto; ?>" data-ap_paterno="<?php echo $ap_paterno;?>" data-ap_materno="<?php echo $ap_materno;  ?>" data-dni="<?php echo $dni;  ?>" >

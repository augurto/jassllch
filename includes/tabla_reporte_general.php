                        ...
                        $estado=$row['estado_pago'];
                         if ($estado==0) { ?>
                            ...
                            <td>        
                                        ...
                                        <a href="../includes/pdf/boleta_pago.php?dni=<?php echo $dni_jass; ?>&datos=<?php echo $nombre; ?>&fecha_pago=<?php echo $pago_hoy; ?>&usuario_atencion=<?php echo $name_user; ?>&pago_mes=<?php echo $pago_mes; ?>&monto_mes=<?php echo $monto_pago; ?>&monto_usuario=<?php echo $deuda; ?>&vuelto=<?php echo $vuelto; ?>&estado=<?php echo $estado; ?>&id_pago=<?php echo $id_jass; ?>" target="_blank">

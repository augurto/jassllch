                        ...
                        $estado=$row['estado'];
                         if ($estado==0) { ?>
                            ...
                            <td>        
                                        ...
                                        <a href="../includes/pdf/boleta_pago.php?dni=<?php echo $dni_jass; ?>&datos=<?php echo $nombre; ?>&fecha_pago=<?php echo $pago_hoy; ?>&usuario_atencion=<?php echo $name_user; ?>&pago_mes=<?php echo $pago_mes; ?>" target="_blank">

                ...
                <div class="col-lg-12">
                    <div class="table-responsive">        
                        ...
                        <?php 
                           $count=1;
                           $dni_url=$_GET['dni'];
                        foreach ($link->query('SELECT * from pagos where dni_usuario_jass = "'.$dni_url.'" AND estado_pago = 0  ORDER BY pago_hoy DESC ') as $row){ // aca se hace la consulta e iterarla con each. ?> 
                        <?php

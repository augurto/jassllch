...
VALUES ('$jass','$dni', '$datos', '$hoy2','$mes_actual', '$year_actual', '$name_user', '$id_user', '$monto_pago', '$deuda', '$vuelto', '$mes_pago','ING', '0', '$mayus_mes_inicio', '$mayus_mes', 'Pago de Agua mes : ', '$cantidadmes')";
